function Signup() {
    document.getElementById('signup-form').addEventListener('submit', function(event) {
        var fnameInput = document.getElementById("fnameForm");
        var fname = fnameInput.value;
        if (fname === "") {
            event.preventDefault();
            alert('First name is empty. Please enter a valid email');
            fnameInput.focus();
            return;
        ...
        var lnameInput = document.getElementById("lnameForm");
        ...
        if (username === "") {
            event.preventDefault();
            alert('Username is empty. Please enter a valid email');
            usernameInput.focus();
            return;
